...
print_query_parameters(SOURCE, DESTINATION, D_TIME, MAX_TRANSFER ,WALKING_FROM_SOURCE, NO_OF_PARTITIONS, WEIGHING_SCHEME, PARTITIONING_ALGORITHM)
########################################
stop_out, route_groups, _, _ = read_partitions_new(stop_times_file, FOLDER, part=NO_OF_PARTITIONS, scheme=WEIGHING_SCHEME, algo=PARTITIONING_ALGORITHM)
print("Optimal journeys are:\n###################################")
start = time_measure()
output = Hypraptor(SOURCE, DESTINATION, D_TIME, MAX_TRANSFER, WALKING_FROM_SOURCE, CHANGE_TIME_SEC, PRINT_PARA, stop_out,
