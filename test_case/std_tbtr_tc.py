...
########################################
start = time_measure()
output = tbtr(SOURCE, DESTINATION, D_TIME, MAX_TRANSFER, WALKING_FROM_SOURCE, PRINT_PARA, routes_by_stop_dict, stops_dict, stoptimes_dict, footpath_dict,
              trip_transfer_dict, trip_set)
