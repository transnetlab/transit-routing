"""
Module contains the test case for One-To-Many rRAPTOR implementation
"""
...
OPTIMIZED = 0
D_TIME = -1
print_query_parameters(SOURCE, DESTINATION_LIST, D_TIME, MAX_TRANSFER, WALKING_FROM_SOURCE)
########################################
...
print(f'Time for Onetomany rraptor: {round((time_measure() - start) * 1000)} milliseconds')
########################################
